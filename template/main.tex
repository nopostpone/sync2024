...
\fancyhead[LO,RE]{}
\fancyhead[C]{\bfseries nopostpone@qq.com}
\fancyfoot{}
...
\renewcommand{\maketitle} {
    ...
    \vskip 1em
    {\Large \textbf{\@author\ | \texttt{SHU-Think Carefully}} \par}
    \vskip 1em
    {\@date \par}
    \vskip 1em
    {\textbf{v1.3} \textcolor{red}{$\bullet$}\textcolor{yellow}{$\bullet$}\textcolor{green}{$\bullet$}\textcolor{cyan}{$\bullet$}\textcolor{blue}{$\bullet$} \par}
    \vskip 1em
}
\makeatother
