...
\renewcommand{\maketitle} {
    ...
    {\@date \par}
    \vskip 1em
    {\textbf{v1.0} \textcolor{red}{$\bullet$}\textcolor{yellow}{$\bullet$}\textcolor{green}{$\bullet$}\textcolor{cyan}{$\bullet$}\textcolor{blue}{$\bullet$} \par}
    \vskip 1em
}
\makeatother
...
\textbf{\color{red}{Attention}}: 0-indexed, $[l, r)$.
	...
	\lstinputlisting{src/polynomial/NTT.cpp}
	...
	\section{Geometry}
	\lstinputlisting{src/geometry/2d.cpp}
	
	% ==================== 6 util ====================
	
	\section{Util}
	\subsection{Mod Integer}
	\lstinputlisting{src/util/Simplify ModInt.cpp}
